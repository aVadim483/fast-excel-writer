...
* [Sheets](/docs/02-sheets.md)
    ...
    * [Print Area](/docs/02-sheets.md#print-area)
    * [Page Layout](/docs/02-sheets.md#page-layout)
    * [Print Header and Footer](/docs/02-sheets.md#page-layout)
...
* [Adding Images](/docs/05-images.md)
* [Adding Notes](/docs/06-notes.md)
* [Charts](/docs/07-charts.md)
    * [Simple usage](/docs/07-charts.md#simple-usage-of-chart)
    * [Combo charts](/docs/07-charts.md#combo-charts)
    * [Multiple charts](/docs/07-charts.md#multiple-charts)
    * [Chart types](/docs/07-charts.md#chart-types)
    * [Useful Chart Methods](/docs/07-charts.md#useful-chart-methods)
...
* [Data validation](/docs/08-validation.md)
    * [Simple usage](/docs/08-validation.md#simple-usage)
    * [Define filters](/docs/08-validation.md#define-filters)
    * [Check type of value](/docs/08-validation.md#check-type-of-value)
    * [Custom filters](/docs/08-validation.md#custom-filters)
    * [All Data Validation settings](/docs/08-validation.md#all-data-validation-settings)
    * [More than 64K validation rules](/docs/08-validation.md#more-than-64k-validation-rules)
* [Conditional Formatting](/docs/09-conditional.md)
    * [Simple usage](/docs/09-conditional.md#simple-usage)
    * [General cell value check](/docs/09-conditional.md#general-cell-value-check)
    * [Expressions](/docs/09-conditional.md#expressions)
    * [Gradient fill depending on values (colorScale)](/docs/09-conditional.md#gradient-fill-depending-on-values-colorscale)
    * [Data strip inside a cell (dataBar)](/docs/09-conditional.md#data-strip-inside-a-cell-databar)
