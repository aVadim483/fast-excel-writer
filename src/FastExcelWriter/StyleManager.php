...
class StyleManager
{
    ...
    protected static array $borderStyleDefines = [Style::BORDER_STYLE_THIN, Style::BORDER_STYLE_MEDIUM, Style::BORDER_STYLE_THICK, Style::BORDER_STYLE_DASH_DOT,
        Style::BORDER_STYLE_DASH_DOT_DOT, Style::BORDER_STYLE_DASHED, Style::BORDER_STYLE_DOTTED, Style::BORDER_STYLE_DOUBLE, Style::BORDER_STYLE_HAIR,
        Style::BORDER_STYLE_MEDIUM_DASH_DOT, Style::BORDER_STYLE_MEDIUM_DASH_DOT_DOT, Style::BORDER_STYLE_MEDIUM_DASHED, Style::BORDER_STYLE_SLANT_DASH_DOT];
    ...
    public function __construct(?array $options)
    {
        self::$instance = $this;
        $defaultFont = [
            'font-name' => Font::DEFAULT_FONT_NAME,
    ...
    protected static function _borderStyleName(string $styleName): ?string
    {
        static $styleNames = [
            Style::BORDER_NONE => 0,
            Style::BORDER_THIN => 1,
            Style::BORDER_MEDIUM => 2,
            Style::BORDER_THICK => 3,
            Style::BORDER_DASH_DOT => 4,
            Style::BORDER_DASH_DOT_DOT => 5,
            Style::BORDER_DASHED => 6,
            Style::BORDER_DOTTED => 7,
            Style::BORDER_DOUBLE => 8,
            Style::BORDER_HAIR => 9,
            Style::BORDER_MEDIUM_DASH_DOT => 10,
            Style::BORDER_MEDIUM_DASH_DOT_DOT => 11,
            Style::BORDER_MEDIUM_DASHED => 12,
            Style::BORDER_SLANT_DASH_DOT => 13,
        ];
     ...
     * @return $this
     */
    public function setLocaleSettings(array $localeData): StyleManager
    {
