## FastExcelWriter - Data Проверка данных (since v.6.0)
...
#### DataПроверка данных::integer($operator, $formulas);
...
#### DataПроверка данных::decimal($operator, $formulas);

The same as ```integer```.

#### DataПроверка данных::textLength($operator, $formulas);

The same as ```integer```.

#### DataПроверка данных::date($operator, $formulas);
...
#### DataПроверка данных::dropDown($formulas);
...
### All Data Проверка данных settings
